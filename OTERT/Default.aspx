<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="OTERT._Default" %>
...
<head runat="server">
    ...
    <script src="Scripts/modernizr.custom.63321.js" type="text/javascript"></script>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (returnedLogin.result == "OK") {
                                $(location).attr("href", "/Pages/Administrator/Users.aspx");
                            } else {
                                hideErrors();
