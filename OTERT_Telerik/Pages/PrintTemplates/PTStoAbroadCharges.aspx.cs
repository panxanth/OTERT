...
namespace OTERT.Pages.PrintTemplates {
    ...
    public partial class PTStoAbroadCharges : Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Διαχείριση Εκτυπώσεων > Χρεωπιστωτικό";
                gridMain.MasterTableView.Caption = "Διαχείριση Εκτυπώσεων > Χρεωπιστωτικό";
                textFromSession = "";
