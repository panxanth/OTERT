...
namespace OTERT.Pages.PrintTemplates {
    ...
    public partial class PrintMailPTSToGRAdmin : Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Διαχείριση Εκτυπώσεων > Επιστολή ΠΤΣ προς Ελλάδα";
                gridMain.MasterTableView.Caption = "Διαχείριση Εκτυπώσεων > Επιστολή ΠΤΣ προς Ελλάδα";
                textFromSession = "";
