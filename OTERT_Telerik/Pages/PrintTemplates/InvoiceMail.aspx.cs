...
namespace OTERT.Pages.PrintTemplates {
    ...
    public partial class InvoiceMail : Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Διαχείριση Εκτυπώσεων > Τιμολόγιο (Email)";
                gridMain.MasterTableView.Caption = "Διαχείριση Εκτυπώσεων > Τιμολόγιο (Email)";
                textFromSession = "";
