...
namespace OTERT.Pages.PrintTemplates {
    ...
    public partial class PrintMailPTSToGR : Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Εκτυπωτικά > Εκτύπωση Επιστολής Προς Ελλάδα";
                gridMain.MasterTableView.Caption = "Εκτυπωτικά > Εκτύπωση Επιστολής Προς Ελλάδα";
                textFromSession = "";
        ...
        protected void gridMain_ItemCommand(object sender, GridCommandEventArgs e) {
            if (e.CommandName == "invPrint") {
                ...
                try {
                    ...
                    RadFlowDocument curDoc = LoadSampleDocument("mailCosmote");
                    ...
                    currPar.Spacing.SpacingAfter = 0;
                    currRun = currPar.Inlines.AddRun("Μ. Μανώλη");
                    ...
                    currPar.Spacing.SpacingAfter = 0;
                    currRun = currPar.Inlines.AddRun("210-8220399");
                    ...
                    currPar.Spacing.SpacingAfter = 0;
                    currRun = currPar.Inlines.AddRun("210-8225199");
                    ...
                    string test = "Μήτσος";
                    var normalizedString = test.Normalize(System.Text.NormalizationForm.FormC);
                    ...
                    currRun = editor.InsertText("ΣΑΟΥΣΟΠΟΥΛΟΥ ΑΝΝΑ");
                    currRun.Properties.FontWeight.LocalValue = FontWeights.Bold;
                    currPar = insertParagraph(editor);
                    currPar.Indentation.LeftIndent = Telerik.Windows.Documents.Media.Unit.InchToDip(3);
                    currPar.TextAlignment = Alignment.Center;
                    currRun = editor.InsertText("ΠΡΟΪΣΤ.ΤΜ. ΡΑΔΙΟΕΠΙΚΟΙΝΩΝΙΩΝ Ρ/Τ ΜΕΤΑΔ.");
                    currRun.Properties.FontWeight.LocalValue = FontWeights.Bold;
