...
namespace OTERT.Pages.PrintTemplates {
    ...
    public partial class PTStoGRInvoices : Page {
        ...
        const string pageUniqueName = "PTStoGRInvoices_";

        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Διαχείριση Εκτυπώσεων > ΠΤΣ προς Ελλάδα - Αποδείξεις";
                gridMain.MasterTableView.Caption = "Διαχείριση Εκτυπώσεων > ΠΤΣ προς Ελλάδα - Αποδείξεις";
                textFromSession = "";
