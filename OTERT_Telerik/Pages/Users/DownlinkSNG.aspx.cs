...
namespace OTERT.Pages.UserPages {
    ...
    public partial class DownlinkSNG : Page {

        protected RadGrid gridMain;
        protected RadAjaxManager RadAjaxManager1;
        protected RadWindowManager RadWindowManager1;
        protected int pageID = 12;
        protected int pageDistanceID = 11;
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Έργα > Έκτακτα > Downlink > Μεταφερόμενοι Δορυφορικοί Σταθμοί (SNG)";
                gridMain.MasterTableView.Caption = "<div id='MTVCaption'>Έργα > Έκτακτα > Downlink > Μεταφερόμενοι Δορυφορικοί Σταθμοί (SNG)</div>";
                JobsID = -1;
            ...
            */
            ...
            if (e.Item is GridEditableItem && e.Item.IsInEditMode && e.Item.OwnerTableView.Name == "Master") {
                ...
                try {
                    ...
                    ddlDistances.DataSource = cont3.GetDistancesForPageID(pageDistanceID);
