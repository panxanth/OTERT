<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Inside.Master" Culture="el-GR" AutoEventWireup="true" CodeBehind="PTStoGRList.aspx.cs" Inherits="OTERT.Pages.UserPages.PTStoGRList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PHContent" runat="server">
    ...
    <div>
        <telerik:RadGrid ID="gridMain" runat="server" AutoGenerateColumns="false" MasterTableView-AllowPaging="true" MasterTableView-AllowCustomPaging="true" MasterTableView-PageSize="10" EnableViewState="true" Skin="Metro"
            ...
            <MasterTableView DataKeyNames="ID,OrderPTSGR2ID,Order.OrdersPTSGRID" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnCurrentPage" AllowFilteringByColumn="True" NoMasterRecordsText="Δεν υπάρχουν ακόμη εγγραφές" Name="Master">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="OrderPTSGR2ID" HeaderText="Πάροχος Α/Α" ReadOnly="true" ForceExtractValue="Always" ConvertEmptyStringToNull="true" AllowFiltering="false" HeaderStyle-Font-Bold="true" AllowSorting="false" />
                    <telerik:GridTemplateColumn UniqueName="CountryID" DataField="Order.CountryID" SortExpression="Order.CountryID" HeaderText="Από Χώρα" HeaderStyle-Font-Bold="true" AllowSorting="true" >
                        <ItemTemplate>
                            <asp:Label Text='<% #Eval("Order.Country.NameGR") %>' runat="server" /> 
                        </ItemTemplate>
                        <FilterTemplate>
                    ...
                    <telerik:GridTemplateColumn UniqueName="ProviderID" DataField="Order.Provider.ID" SortExpression="Order.Provider.ID" HeaderText="Πάροχος" HeaderStyle-Font-Bold="true" AllowSorting="true" >
                        ...
                        <FilterTemplate>
		                    <telerik:RadDropDownList runat="server" ID="ddlProvidersFilter" RenderMode="Lightweight" AppendDataBoundItems="true" AutoPostBack="true" CausesValidation="false" Width="280px" DropDownHeight="400px" OnSelectedIndexChanged="ddlProvidersFilter_SelectedIndexChanged" OnPreRender="ddlProvidersFilter_PreRender" />
	                    </FilterTemplate>
                    </telerik:GridTemplateColumn>
