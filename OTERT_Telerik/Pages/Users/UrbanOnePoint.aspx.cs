    ...
    public partial class UrbanOnePoint : Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                ...
                gridMain.MasterTableView.Caption = "<div id='MTVCaption'>Έργα > Προσωρινά > Αστικά > 1 Σημείο Κωδικοποίησης</div>";
                JobsID = -1;
            ...
            using (var dbContext = new OTERTConnStr()) {
                ...
                if (curTask != null) {
                    try {
                        ...
                        CheckBox chkIsLocked = (CheckBox)editableItem.FindControl("chkIsLocked");
