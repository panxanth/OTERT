...
namespace OTERT.Pages.UserPages {
    ...
    public partial class LongDistanceTwoPoints : Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Έργα > Προσωρινά > Υπεραστικά > 2 Σημεία Κωδικοποίησης";
                gridMain.MasterTableView.Caption = "<div id='MTVCaption'>Έργα > Προσωρινά > Υπεραστικά > 2 Σημεία Κωδικοποίησης</div>";
                JobsID = -1;
