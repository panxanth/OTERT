...
namespace OTERT.Pages.UserPages {
    ...
    public partial class LongDistanceOnePoint : Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Έργα > Προσωρινά > Υπεραστικά > 1 Σημείο Κωδικοποίησης";
                gridMain.MasterTableView.Caption = "<div id='MTVCaption'>Έργα > Προσωρινά > Υπεραστικά > 1 Σημείο Κωδικοποίησης</div>";
                JobsID = -1;
