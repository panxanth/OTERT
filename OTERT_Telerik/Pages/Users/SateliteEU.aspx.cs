    ...
    public partial class SateliteEU : Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (!Page.IsPostBack) {
                ...
                gridMain.MasterTableView.Caption = "<div id='MTVCaption'>Έργα > Έκτακτα > Δορυφορικά > EUTELSAT</div>";
                JobsID = -1;
        ...
        protected void gridMain_ItemCreated(object sender, GridItemEventArgs e) {
            if (e.Item.OwnerTableView.Name == "Master") {
                ...
                /*
                if (e.Item is GridEditableItem && e.Item.IsInEditMode) {
                    RadAsyncUpload upload = ((GridEditableItem)e.Item)["Upload"].FindControl("uplFile") as RadAsyncUpload;
