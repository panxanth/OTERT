...
namespace OTERT.Pages.UserPages {
    ...
    public partial class SateliteHS : Page {
        ...
        protected string sateliteStartsWith = "HE";
        ...
        protected void Page_Load(object sender, EventArgs e) {
            if (!Page.IsPostBack) {
                pageTitle = ConfigurationManager.AppSettings["AppTitle"].ToString() + "Έργα > Έκτακτα > Δορυφορικά > HELLASSAT";
                gridMain.MasterTableView.Caption = "<div id='MTVCaption'>Έργα > Έκτακτα > Δορυφορικά > HELLASSAT<div>";
                JobsID = -1;
