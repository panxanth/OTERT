<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/InsideNoMenu.Master" Culture="el-GR" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="OTERT.Pages.Password.ChangePassword" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PHContent" runat="server">
    ...
    <div>
        ...
        <table style="margin: 0 auto;">
            ...
            <tr>
                <td style="height: 35px;">Παλιός Κωδικός Χρήστη: </td>
                <td><asp:TextBox ID="txtOldPasswd" runat="server" TextMode="Password" Width="230" EnableViewState="true" /></td>
            </tr>
            <tr>
                <td colspan="2"><asp:CustomValidator ID= "valOldPasswd" runat="server" Enabled="true" ControlToValidate="txtOldPasswd" ValidateEmptyText="true" Display="Dynamic" ForeColor="Red" OnServerValidate="valOldPasswd_Validate" /></td>
            </tr>
            <tr>
