<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Inside.Master" Culture="el-GR" AutoEventWireup="true" CodeBehind="PTSToGRTransmit.aspx.cs" Inherits="OTERT.Pages.Printouts.PTSToGRTransmit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PHContent" runat="server">
    ...
    <div>
        <table>
            <tr>
                <td valign="middle">&nbsp;&nbsp;Αριθμός:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><asp:TextBox ID="txtNumber" runat="server" Text="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td></td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;&nbsp;Αριθμός Invoice:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td><asp:TextBox ID="txtNumberInvoice" runat="server" Text="" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td></td>
            </tr>
            <tr>
                <td valign="middle">&nbsp;&nbsp;Ημερομηνίες:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
