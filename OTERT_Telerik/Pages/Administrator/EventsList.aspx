<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Inside.Master" AutoEventWireup="true" CodeBehind="EventsList.aspx.cs" Inherits="OTERT_Telerik.Pages.Administrator.EventsList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="PHContent" runat="server">
    ...
    <div>
        <telerik:RadGrid ID="gridMain" runat="server" AutoGenerateColumns="false" AllowPaging="true" AllowCustomPaging="true" PageSize="10" EnableViewState="true"
            ...
            <MasterTableView DataKeyNames="ID" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnCurrentPage" AllowFilteringByColumn="True" NoMasterRecordsText="Δεν υπάρχουν ακόμη εγγραφές">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="NameEN" HeaderText="Όνομα (EN)" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" ShowFilterIcon="true" />
