<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Inside.Master" Culture="el-GR" AutoEventWireup="true" Culture="el-GR" CodeBehind="RequestedPositionsList.aspx.cs" Inherits="OTERT.Pages.Administrator.RequestedPositionsList" %>
        ...
        <telerik:RadGrid ID="gridMain" runat="server" AutoGenerateColumns="false" AllowPaging="true" AllowCustomPaging="true" PageSize="10" Skin="Metro"
            ...
            <MasterTableView DataKeyNames="ID" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnCurrentPage" NoMasterRecordsText="Δεν υπάρχουν ακόμη εγγραφές">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="NameEN" HeaderText="Όνομα (ΕΝ)" HeaderStyle-Font-Bold="true" />
                    <telerik:GridButtonColumn ConfirmText="Να διαγραφεί αυτή η Αιτούμενη Θέση;" ConfirmDialogType="RadWindow" ConfirmTitle="Διαγραφή" ButtonType="FontIconButton" HeaderTooltip="Διαγραφή" CommandName="Delete" />
                </Columns>
                <EditFormSettings>
