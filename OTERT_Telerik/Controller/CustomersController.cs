...
namespace OTERT.Controller {
    ...
    public class CustomersController {
        ...
        public List<CustomerB> GetPTSCustomers() {
            using (var dbContext = new OTERTConnStr()) {
                try {
                    dbContext.Configuration.ProxyCreationEnabled = false;
                    List<CustomerB> data = (from us in dbContext.Customers
        ...
        public List<CustomerB> GetForeignPTSCustomers() {
            using (var dbContext = new OTERTConnStr()) {
                try {
                    dbContext.Configuration.ProxyCreationEnabled = false;
                    List<CustomerB> data = (from us in dbContext.Customers
        ...
        public List<CustomerB> GetCustomersForCountryPTS(int CountryID) {
            using (var dbContext = new OTERTConnStr()) {
                try {
                    dbContext.Configuration.ProxyCreationEnabled = false;
                    List<CustomerB> data = (from us in dbContext.Customers
                                            select new CustomerB {
                                                ...
                                                IsPTS = us.IsPTS,
                                                IsTemporary = us.IsTemporary
                                            }).Where(k => k.CountryID == CountryID && k.IsPTS == true).OrderBy(o => o.NameGR).ToList();
                    return data;
                }
                catch (Exception) { return null; }
            }
                ...
                try {
                    ...
                    List<CustomerB> data = (from us in dbContext.Customers
                                            select new CustomerB {
                                                ...
                                                IsPTS = us.IsPTS,
                                                IsTemporary = us.IsTemporary
                                            }).Where(k => k.IsPTS == true && k.CountryID == CountryID && k.IsProvider == true).OrderBy(o => o.NameGR).ToList();
                    return data;
                }
                catch (Exception) { return null; }
            }
                ...
                try {
                    ...
                    List<CustomerB> data = (from us in dbContext.Customers
                                            select new CustomerB {
                                                ...
                                                IsPTS = us.IsPTS,
                                                IsTemporary = us.IsTemporary
                                            }).Where(k => k.IsPTS == true && k.CountryID != 1 && k.IsProvider == true).OrderBy(o => o.NameGR).ToList();
                    return data;
                }
                catch (Exception) { return null; }
            }
